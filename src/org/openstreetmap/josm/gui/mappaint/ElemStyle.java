...
abstract public class ElemStyle implements StyleKeys {
    ...
    //sjd227: Added to paint node
    public void paintGPSBodyPrimitive(OsmPrimitive primitive, MapPaintSettings settings, StyledMapRenderer painter,
            boolean selected, boolean member, Color bodyColor) {
