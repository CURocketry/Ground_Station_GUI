...
public class NodeElemStyle extends ElemStyle implements StyleKeys {
    ...
    //sjd227
    @Override
    public void paintGPSBodyPrimitive(OsmPrimitive primitive, MapPaintSettings settings, StyledMapRenderer painter, boolean selected, boolean member, Color bodyColor) {
        GPSBodyNode n= (GPSBodyNode) primitive;
        if (mapImage != null && painter.isShowIcons()) {
                ...
                painter.drawGPSBodyNodeIcon(n, nodeIcon, Utils.color_int2float(mapImage.alpha), selected, member, bodyColor);
            } else if (symbol != null) {
                ...
                */
                ...
                //sjd227: draws node w/ gps body color
