...
public class StyledMapRenderer extends AbstractMapRenderer {
    ...
    private class StyleCollector {
        ...
        public void drawAll() {
            ...
            for (StyleRecord r : styleElems) {
                //System.out.println("Here: " + (r.osm instanceof GPSBodyNode));
                if (r.osm instanceof GPSBodyNode){
                    GPSBodyNode n= (GPSBodyNode) r.osm;
                    r.style.paintGPSBodyPrimitive(
                            r.osm,
                            paintSettings,
    ...
    //sjd227: added int bodyNumb to set color according to GPS body
    public void drawGPSBodyNodeIcon(Node n, Image img, float alpha, boolean selected, boolean member, Color bodyColor) {
        Point p = nc.getPoint(n);
