    ...
    public Demo() {
        ...
        tileSourceSelector.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                //JFileChooser fc = createAndOpenFileChooser(true, true, null,null,JFileChooser.FILES_ONLY, true, null);
                /*
                JFileChooser fc = JFileChooserManager(true,null,null).createFileChooser(true,null,null,true,JFileChooser.FILES_ONLY).openFileChooser();
                if (fc == null)
                    return;
